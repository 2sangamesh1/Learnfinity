...
const LoginPage = () => {
  ...
  // 4. Replace the entire handleLogin function
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Now we can navigate the user to their dashboard.
      navigate('/dashboard');
    ...
    <div className="min-h-screen w-screen flex flex-col items-center justify-center p-4 relative">
      ...
      >
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight text-neutral-100">Welcome Back</h1>
          <p className="text-neutral-400 mt-2">Log in to access your study planner.</p>
        </div>
